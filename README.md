...
When manually installing OSMnx, Python Extension Packages can be downloaded from [here for windows](https://www.lfd.uci.edu/~gohlke/pythonlibs/) and [Homebrew for Mac](https://brew.sh/).
